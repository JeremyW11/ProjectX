...
Past patch stacks (P5-P8, 2026-05-20~2026-06-25) are archived in `CHANGELOG.md` — not loaded here since git log is authoritative for "what changed"; this file stays focused on gotchas and decisions that aren't derivable from the code itself.
